...
tbl_lifetables |> 
  ...
  labs(
    title = "Probabiltiy of Being Alive Based on Year Born",
    subtitle = "Probability of Being Alive Given Year Born In",
    x = "Year",
    y = "Probability",
    caption = "Source: SSA"
  ) +
...
tbl_lifetables_extended_2022 |> 
 ...
 geom_line() +
  ...
  # Add labels (title, subtitle, x, y, caption)
labs(title = "Interpolated Probabiltiy of Being Alive Based on Year Born",
    subtitle = "Interpolated Probability of Being Alive Given Year Born In",
    x = "Year",
    y = "Probability",
    caption = "Source: SSA")
...
ggplot(aes(x = year)) +
    ...
    geom_line(aes(y = nb_births), color = 'orange') +
    ...
    labs(
      ...
      subtitle = glue::glue("Age Distribution by Year for Girls Named {my_name}"),
      x = "Year",
      y = "Number of Births"
    ) +
...
tbl_names_extended_age <- tbl_names_extended |> 
  ...
  inner_join(tbl_names_female_top_25) |>
...
tbl_names_extended_age |> 
  ...
  labs(
    ...
    subtitle = "Among Americans estimaes to be alive",
    x = "Age",
    y = "Name"
  ) +
