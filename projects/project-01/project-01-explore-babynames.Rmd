...
tbl_names_by_letter |> 
  ...
  facet_wrap(~ sex, scales = "free_y") +
  # Add labels (title, subtitle, x, y)
  labs(title = "Percent of Baby Names that End with a Given Letter", subtitle = "Births (%) by Last Letter of Name", x = "Last Letter of Name", y = "Births (%)") +
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = glue::glue("Percent of Births ending with {my_letter} over the years"),
      caption = "Source: SSA",
      x = "Year",
      y = 'Births (%)'
    ) +
